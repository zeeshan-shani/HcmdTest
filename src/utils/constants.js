...
export const CONST = {
  ...
  GHOST_IMAGE:
    "https://chatapp-storage-2022.s3.us-west-2.amazonaws.com/incognito1.png",
...
export const SOCKET = {
  ...
  REQUEST: {
    ...
    // Pin Sockets starts here
    ADD_PIN_MESSAGE: "add_pin_to_message",
	PIN_ADDED:"pin_added_to_message",
    // Pin sockets end here
  },
  RESPONSE: {
