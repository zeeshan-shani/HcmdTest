...
class ImportantMessageService extends PlaceholderApiProvider {
...
const importantMessageService = new ImportantMessageService('/importantmessage');

export default importantMessageService;
