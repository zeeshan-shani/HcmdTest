...
class PreTypedMessageService extends PlaceholderApiProvider {
...
const preTypedMessageService = new PreTypedMessageService('/pretypedMessage');

export default preTypedMessageService;
