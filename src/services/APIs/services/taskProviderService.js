...
class TaskProviderService extends PlaceholderApiProvider {
...
const taskProviderService = new TaskProviderService('/taskProvider');

export default taskProviderService;
