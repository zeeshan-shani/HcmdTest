...
class ChatTemplateService extends PlaceholderApiProvider {
...
const chatTemplateService = new ChatTemplateService('/chatTemplate');

export default chatTemplateService;
